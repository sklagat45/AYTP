                ...
                <div className="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
                    <div className="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
                        ...
                        <div className="flex justify-items-center items-center space-x-10 py-5">
                            <button className="mx-auto lg:mx-0 bg-white hover:bg-black text-black hover:text-white font-bold my-6 py-2 px-6 rounded-full focus:shadow-md transform transition hover:scale-110 duration-300 ease-in-out cursor-pointer">
                                View Courses
                            </button>
                            <button className=" mx-auto lg:mx-0 bg-transparent hover:bg-white text-white font-bold hover:text-black my-6 py-2 px-6 border border-white border-bold hover:border-transparent rounded-full focus:shadow-md transform transition hover:scale-110 duration-300 ease-in-out cursor-pointer">
                                Get Started
                            </button>
                        </div> 
                    </div>
